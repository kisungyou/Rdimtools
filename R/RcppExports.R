...
dt_pca <- function(X, ndim, ptype, cor) {
    .Call('_Rdimtools_dt_pca', PACKAGE = 'Rdimtools', X, ndim, ptype, cor)
}

dt_fa <- function(X, ndim, ptype, maxiter, tolerance) {
    .Call('_Rdimtools_dt_fa', PACKAGE = 'Rdimtools', X, ndim, ptype, maxiter, tolerance)
}

dt_spca <- function(X, ndim, ptype, mu, rho, abstol, reltol, maxiter) {
    .Call('_Rdimtools_dt_spca', PACKAGE = 'Rdimtools', X, ndim, ptype, mu, rho, abstol, reltol, maxiter)
}

dt_mds <- function(X, ndim, ptype) {
    .Call('_Rdimtools_dt_mds', PACKAGE = 'Rdimtools', X, ndim, ptype)
}

admm_lasso <- function(A, b, lambda) {
    .Call('_Rdimtools_admm_lasso', PACKAGE = 'Rdimtools', A, b, lambda)
}

dt_lasso <- function(X, ndim, ptype, y, ycenter, lambda) {
    .Call('_Rdimtools_dt_lasso', PACKAGE = 'Rdimtools', X, ndim, ptype, y, ycenter, lambda)
}

dt_enet <- function(X, ndim, ptype, y, ycenter, lambda1, lambda2) {
    .Call('_Rdimtools_dt_enet', PACKAGE = 'Rdimtools', X, ndim, ptype, y, ycenter, lambda1, lambda2)
}

dt_lmds <- function(X, ndim, ptype, npts) {
    .Call('_Rdimtools_dt_lmds', PACKAGE = 'Rdimtools', X, ndim, ptype, npts)
}

dt_rpca <- function(X, ndim, ptype, mu, lambda) {
    .Call('_Rdimtools_dt_rpca', PACKAGE = 'Rdimtools', X, ndim, ptype, mu, lambda)
}
