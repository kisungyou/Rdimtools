...
#'
#' \dontrun{
#' ## Out-of-CRAN example; run at your machine !
...
#' plot(out3$Y[,1], out3$Y[,2], main="max k=3", col=cols)
#' plot(out6$Y[,1], out6$Y[,2], main="max k=6", col=cols)
#' plot(out9$Y[,1], out9$Y[,2], main="max k=9", col=cols)
#' par(opar)
#' }
#'
#'
