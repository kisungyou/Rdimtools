...
[![CRAN Downloads](https://cranlogs.r-pkg.org/badges/grand-total/Rdimtools?color=green)](https://cran.r-project.org/package=Rdimtools)
<!-- badges: end -->
...
The logo icon is made by [Freepik](https://www.flaticon.com/authors/freepik/) from [www.flaticon.com](https://www.flaticon.com/). The rotating Swiss Roll image can be found on the late [Sam Roweis](https://cs.nyu.edu/home/people/in_memoriam/roweis/)'s website.
